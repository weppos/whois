...
#
#   /spec/whois/answer/parser/responses/whois.nic.af/status_registered_spec.rb
#
...
describe Whois::Answer::Parser::WhoisNicAf, "status_registered.expected" do
  ...
  context "#created_on" do
    it do
      ...
      @parser.created_on.should == Time.parse("2009-10-05")
    end
  end
