...
#
#   /spec/whois/answer/parser/responses/whois.sgnic.sg/status_registered_spec.rb
#
...
describe Whois::Answer::Parser::WhoisSgnicSg, "status_registered.expected" do
  ...
  context "#expires_on" do
    it do
      ...
      @parser.expires_on.should == Time.parse("2011-01-03 00:00:00")
    end
  end
