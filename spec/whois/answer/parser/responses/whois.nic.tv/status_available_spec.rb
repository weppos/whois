...
#
#   /spec/whois/answer/parser/responses/whois.nic.tv/status_available_spec.rb
#
...
describe Whois::Answer::Parser::WhoisNicTv, "status_available.expected" do
  ...
  context "#domain" do
    it do
      @parser.domain.should == "u34jedzcq.tv"
    end
  end
