...
#
#   /spec/whois/answer/parser/responses/whois.audns.net.au/status_registered_spec.rb
#
...
describe Whois::Answer::Parser::WhoisAudnsNetAu, "status_registered.expected" do
