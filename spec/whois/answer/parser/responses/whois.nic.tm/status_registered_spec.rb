...
#
#   /spec/whois/answer/parser/responses/whois.nic.tm/status_registered_spec.rb
#
...
describe Whois::Answer::Parser::WhoisNicTm, "status_registered.expected" do

  before(:each) do
    file = fixture("responses", "whois.nic.tm/status_registered.txt")
  ...
  context "#domain" do
    it do
      @parser.domain.should == "google.tm"
    end
  end
