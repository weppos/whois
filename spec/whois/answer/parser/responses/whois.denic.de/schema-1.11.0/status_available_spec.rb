...
#
#   /spec/whois/answer/parser/responses/whois.denic.de/schema-1.11.0/status_available_spec.rb
#
...
describe Whois::Answer::Parser::WhoisDenicDe, "status_available.expected" do
  ...
  before(:each) do
    file = fixture("responses", "whois.denic.de/schema-1.11.0/status_available.txt")
