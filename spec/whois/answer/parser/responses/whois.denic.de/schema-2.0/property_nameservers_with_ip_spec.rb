...
#
#   /spec/whois/answer/parser/responses/whois.denic.de/schema-2.0/property_nameservers_with_ip_spec.rb
#
...
describe Whois::Answer::Parser::WhoisDenicDe, "property_nameservers_with_ip.expected" do

  before(:each) do
    file = fixture("responses", "whois.denic.de/schema-2.0/property_nameservers_with_ip.txt")
