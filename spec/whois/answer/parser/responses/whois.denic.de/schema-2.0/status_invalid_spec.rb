...
#
#   /spec/whois/answer/parser/responses/whois.denic.de/schema-2.0/status_invalid_spec.rb
#
...
describe Whois::Answer::Parser::WhoisDenicDe, "status_invalid.expected" do

  before(:each) do
    file = fixture("responses", "whois.denic.de/schema-2.0/status_invalid.txt")
