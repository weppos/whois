...
#
#   /spec/whois/answer/parser/responses/whois.nic.mg/status_registered_spec.rb
#
...
require 'spec_helper'
require 'whois/answer/parser/whois.nic.mg.rb'

describe Whois::Answer::Parser::WhoisNicMg, "status_registered.expected" do
