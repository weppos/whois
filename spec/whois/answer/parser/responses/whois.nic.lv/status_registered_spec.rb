...
#
#   /spec/whois/answer/parser/responses/whois.nic.lv/status_registered_spec.rb
#
...
describe Whois::Answer::Parser::WhoisNicLv, "status_registered.expected" do

  before(:each) do
    file = fixture("responses", "whois.nic.lv/status_registered.txt")
