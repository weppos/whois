...
#
#   /spec/whois/answer/parser/responses/whois.nic.cc/status_available_spec.rb
#
...
require 'spec_helper'
require 'whois/answer/parser/whois.nic.cc.rb'

describe Whois::Answer::Parser::WhoisNicCc, "status_available.expected" do

  before(:each) do
    file = fixture("responses", "whois.nic.cc/status_available.txt")
  ...
  context "#domain" do
    it do
      @parser.domain.should == "u34jedzcq.cc"
    end
  end
