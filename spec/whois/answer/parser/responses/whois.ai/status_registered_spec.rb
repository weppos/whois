...
#
#   /spec/whois/answer/parser/responses/whois.ai/status_registered_spec.rb
#
...
describe Whois::Answer::Parser::WhoisAi, "status_registered.expected" do

  before(:each) do
    file = fixture("responses", "whois.ai/status_registered.txt")
