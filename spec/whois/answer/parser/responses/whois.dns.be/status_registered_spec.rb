...
#
#   /spec/whois/answer/parser/responses/whois.dns.be/status_registered_spec.rb
#
...
describe Whois::Answer::Parser::WhoisDnsBe, "status_registered.expected" do
  ...
  context "#created_on" do
    ...
    it do
      @parser.created_on.should == Time.parse("2000-12-12 00:00:00")
    end
  end
