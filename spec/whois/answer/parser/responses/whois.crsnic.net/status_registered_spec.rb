...
#
#   /spec/whois/answer/parser/responses/whois.crsnic.net/status_registered_spec.rb
#
...
describe Whois::Answer::Parser::WhoisCrsnicNet, "status_registered.expected" do

  before(:each) do
    file = fixture("responses", "whois.crsnic.net/status_registered.txt")
