...
#
#   /spec/whois/answer/parser/responses/whois.registry.gy/status_registered_spec.rb
#
...
require 'spec_helper'
require 'whois/answer/parser/whois.registry.gy.rb'

describe Whois::Answer::Parser::WhoisRegistryGy, "status_registered.expected" do
