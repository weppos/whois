...
#
#   /spec/whois/answer/parser/responses/whois.nic.ki/status_registered_spec.rb
#
...
require 'spec_helper'
require 'whois/answer/parser/whois.nic.ki.rb'

describe Whois::Answer::Parser::WhoisNicKi, "status_registered.expected" do
