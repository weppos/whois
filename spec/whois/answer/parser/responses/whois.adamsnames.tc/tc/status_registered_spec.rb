...
#
#   /spec/whois/answer/parser/responses/whois.adamsnames.tc/tc/status_registered_spec.rb
#
...
describe Whois::Answer::Parser::WhoisAdamsnamesTc, "status_registered.expected" do
  ...
  before(:each) do
    file = fixture("responses", "whois.adamsnames.tc/tc/status_registered.txt")
