...
#
#   /spec/whois/answer/parser/responses/whois.centralnic.com/uk.com/status_registered_spec.rb
#
...
describe Whois::Answer::Parser::WhoisCentralnicCom, "status_registered.expected" do
  ...
  context "#created_on" do
    it do
      ...
      @parser.created_on.should == Time.parse("2001-08-31")
    end
  end
  ...
  context "#expires_on" do
    it do
      ...
      @parser.expires_on.should == Time.parse("2011-08-31")
    end
  end
