...
#
#   /spec/whois/answer/parser/responses/whois.centralnic.com/jpn.com/status_registered_spec.rb
#
...
describe Whois::Answer::Parser::WhoisCentralnicCom, "status_registered.expected" do
  ...
  context "#created_on" do
    ...
    it do
      @parser.created_on.should == Time.parse("2007-06-29")
    end
  end
  ...
  context "#expires_on" do
    ...
    it do
      @parser.expires_on.should == Time.parse("2011-06-29")
    end
  end
