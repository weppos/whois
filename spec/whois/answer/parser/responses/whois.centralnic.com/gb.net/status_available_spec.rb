...
#
#   /spec/whois/answer/parser/responses/whois.centralnic.com/gb.net/status_available_spec.rb
#
...
describe Whois::Answer::Parser::WhoisCentralnicCom, "status_available.expected" do
  ...
  before(:each) do
    file = fixture("responses", "whois.centralnic.com/gb.net/status_available.txt")
