...
#
#   /spec/whois/answer/parser/responses/whois.nic.ve/status_suspended_spec.rb
#
...
describe Whois::Answer::Parser::WhoisNicVe, "status_suspended.expected" do

  before(:each) do
    file = fixture("responses", "whois.nic.ve/status_suspended.txt")
