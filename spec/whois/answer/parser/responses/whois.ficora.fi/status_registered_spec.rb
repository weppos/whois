...
#
#   /spec/whois/answer/parser/responses/whois.ficora.fi/status_registered_spec.rb
#
...
require 'spec_helper'
require 'whois/answer/parser/whois.ficora.fi.rb'

describe Whois::Answer::Parser::WhoisFicoraFi, "status_registered.expected" do
