...
#
#   /spec/whois/answer/parser/responses/whois.nic.at/status_registered_spec.rb
#
...
describe Whois::Answer::Parser::WhoisNicAt, "status_registered.expected" do
  ...
  context "#updated_on" do
    it do
      ...
      @parser.updated_on.should == Time.parse("2006-10-04 14:57:26")
    end
  end
