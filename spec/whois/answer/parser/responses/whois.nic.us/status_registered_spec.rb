...
#
#   /spec/whois/answer/parser/responses/whois.nic.us/status_registered_spec.rb
#
...
describe Whois::Answer::Parser::WhoisNicUs, "status_registered.expected" do
  ...
  context "#created_on" do
    it do
      ...
      @parser.created_on.should == Time.parse("2002-04-19 23:15:57 UTC")
    end
  end
  context "#updated_on" do
    it do
      @parser.updated_on.should be_a(Time)
      @parser.updated_on.should == Time.parse("2009-03-17 09:40:30 UTC")
    end
  end
