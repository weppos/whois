...
#
#   /spec/whois/answer/parser/responses/whois.dns.lu/status_registered_spec.rb
#
...
describe Whois::Answer::Parser::WhoisDnsLu, "status_registered.expected" do
  ...
  context "#created_on" do
    it do
      ...
      @parser.created_on.should == Time.parse("2003-06-04 00:00:00 UTC")
    end
  end
