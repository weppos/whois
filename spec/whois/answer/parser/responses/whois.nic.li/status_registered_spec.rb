...
#
#   /spec/whois/answer/parser/responses/whois.nic.li/status_registered_spec.rb
#
...
require 'spec_helper'
require 'whois/answer/parser/whois.nic.li.rb'

describe Whois::Answer::Parser::WhoisNicLi, "status_registered.expected" do

  before(:each) do
    file = fixture("responses", "whois.nic.li/status_registered.txt")
