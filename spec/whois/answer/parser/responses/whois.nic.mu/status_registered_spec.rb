...
#
#   /spec/whois/answer/parser/responses/whois.nic.mu/status_registered_spec.rb
#
...
describe Whois::Answer::Parser::WhoisNicMu, "status_registered.expected" do
  ...
  context "#updated_on" do
    it do
      ...
      @parser.updated_on.should == Time.parse("2009-12-04")
    end
  end
  context "#expires_on" do
    it do
      @parser.expires_on.should be_a(Time)
      @parser.expires_on.should == Time.parse("2010-12-20")
    end
  end
