...
#
#   /spec/whois/answer/parser/responses/whois.nic.hu/schema-current/status_available_spec.rb
#
...
describe Whois::Answer::Parser::WhoisNicHu, "status_available.expected" do

  before(:each) do
    file = fixture("responses", "whois.nic.hu/schema-current/status_available.txt")
