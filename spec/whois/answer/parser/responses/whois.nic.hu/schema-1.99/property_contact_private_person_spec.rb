...
#
#   /spec/whois/answer/parser/responses/whois.nic.hu/schema-1.99/property_contact_private_person_spec.rb
#
...
describe Whois::Answer::Parser::WhoisNicHu, "property_contact_private_person.expected" do
  ...
  context "#registrant_contact" do
    ...
    it do
      @parser.registrant_contact.name.should         =~ /Buruzs/
    end
    it do
