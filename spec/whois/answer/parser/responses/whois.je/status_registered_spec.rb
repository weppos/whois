...
#
#   /spec/whois/answer/parser/responses/whois.je/status_registered_spec.rb
#
...
require 'spec_helper'
require 'whois/answer/parser/whois.je.rb'

describe Whois::Answer::Parser::WhoisJe, "status_registered.expected" do
