...
#
#   /spec/whois/answer/parser/responses/whois.nic.it/property_admin_contact_spec.rb
#
...
describe Whois::Answer::Parser::WhoisNicIt, "property_admin_contact.expected" do

  before(:each) do
    file = fixture("responses", "whois.nic.it/property_admin_contact.txt")
