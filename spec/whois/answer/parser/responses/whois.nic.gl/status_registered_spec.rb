...
#
#   /spec/whois/answer/parser/responses/whois.nic.gl/status_registered_spec.rb
#
...
describe Whois::Answer::Parser::WhoisNicGl, "status_registered.expected" do
  ...
  context "#created_on" do
    it do
      ...
      @parser.created_on.should == Time.parse("2003-03-11")
    end
  end
