...
#
#   /spec/whois/answer/parser/responses/whois.nic.net.ng/status_registered_spec.rb
#
...
require 'spec_helper'
require 'whois/answer/parser/whois.nic.net.ng.rb'

describe Whois::Answer::Parser::WhoisNicNetNg, "status_registered.expected" do
