...
#
#   /spec/whois/answer/parser/responses/whois.pandi.or.id/status_registered_spec.rb
#
...
describe Whois::Answer::Parser::WhoisPandiOrId, "status_registered.expected" do
  ...
  context "#created_on" do
    ...
    it do
      @parser.created_on.should == Time.parse("2004-12-18")
    end
  end
  context "#updated_on" do
    ...
    it do
      @parser.updated_on.should == Time.parse("2006-07-24")
    end
  end
  context "#expires_on" do
    ...
    it do
      @parser.expires_on.should == Time.parse("2010-08-31")
    end
  end
