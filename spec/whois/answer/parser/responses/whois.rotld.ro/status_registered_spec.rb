...
#
#   /spec/whois/answer/parser/responses/whois.rotld.ro/status_registered_spec.rb
#
...
describe Whois::Answer::Parser::WhoisRotldRo, "status_registered.expected" do

  before(:each) do
    file = fixture("responses", "whois.rotld.ro/status_registered.txt")
