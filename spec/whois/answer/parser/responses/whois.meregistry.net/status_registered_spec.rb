...
#
#   /spec/whois/answer/parser/responses/whois.meregistry.net/status_registered_spec.rb
#
...
describe Whois::Answer::Parser::WhoisMeregistryNet, "status_registered.expected" do
