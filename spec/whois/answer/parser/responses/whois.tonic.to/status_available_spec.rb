...
#
#   /spec/whois/answer/parser/responses/whois.tonic.to/status_available_spec.rb
#
...
describe Whois::Answer::Parser::WhoisTonicTo, "status_available.expected" do

  before(:each) do
    file = fixture("responses", "whois.tonic.to/status_available.txt")
