...
#
#   /spec/whois/answer/parser/responses/whois.nic.nu/status_registered_spec.rb
#
...
describe Whois::Answer::Parser::WhoisNicNu, "status_registered.expected" do
  ...
  context "#updated_on" do
    ...
    it do
      @parser.updated_on.should == Time.parse("2009-05-11")
    end
  end
