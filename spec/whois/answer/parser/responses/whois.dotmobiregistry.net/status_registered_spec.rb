...
#
#   /spec/whois/answer/parser/responses/whois.dotmobiregistry.net/status_registered_spec.rb
#
...
describe Whois::Answer::Parser::WhoisDotmobiregistryNet, "status_registered.expected" do
