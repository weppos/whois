...
#
#   /spec/whois/answer/parser/responses/whois.net.ua/property_nameservers_uppercase_spec.rb
#
...
require 'spec_helper'
require 'whois/answer/parser/whois.net.ua.rb'

describe Whois::Answer::Parser::WhoisNetUa, "property_nameservers_uppercase.expected" do
