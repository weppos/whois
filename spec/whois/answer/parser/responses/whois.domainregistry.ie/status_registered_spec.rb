...
#
#   /spec/whois/answer/parser/responses/whois.domainregistry.ie/status_registered_spec.rb
#
...
describe Whois::Answer::Parser::WhoisDomainregistryIe, "status_registered.expected" do
  ...
  context "#expires_on" do
    ...
    it do
      @parser.expires_on.should == Time.parse("2010-03-21")
    end
  end
