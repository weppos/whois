...
#
#   /spec/whois/answer/parser/responses/whois.nic.im/status_registered_spec.rb
#
...
describe Whois::Answer::Parser::WhoisNicIm, "status_registered.expected" do

  before(:each) do
    file = fixture("responses", "whois.nic.im/status_registered.txt")
  ...
  context "#expires_on" do
    it do
      ...
      @parser.expires_on.should == Time.parse("2010-07-30 23:59:56")
    end
  end
