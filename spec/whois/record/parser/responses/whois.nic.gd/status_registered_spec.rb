...
describe Whois::Record::Parser::WhoisNicGd, "status_registered.expected" do
  ...
  describe "#domain" do
    it do
      subject.domain.should == "google.gd"
    end
  end
  ...
  describe "#created_on" do
    it do
      ...
      subject.created_on.should == Time.parse("2006-12-11 00:00:00")
    end
  end
  describe "#updated_on" do
    it do
      subject.updated_on.should be_a(Time)
      subject.updated_on.should == Time.parse("2013-03-01 00:02:54")
    end
  end
  describe "#expires_on" do
    it do
      subject.expires_on.should be_a(Time)
      subject.expires_on.should == Time.parse("2013-12-11 00:00:00")
    end
  end
  ...
  describe "#registrant_contacts" do
    it do
      ...
      subject.registrant_contacts[0].id.should            == "P-GFI26"
  ...
  describe "#admin_contacts" do
    it do
      ...
      subject.admin_contacts[0].id.should            == "P-GFI26"
  ...
  describe "#technical_contacts" do
    it do
      ...
      subject.technical_contacts[0].id.should            == "P-GFI26"
