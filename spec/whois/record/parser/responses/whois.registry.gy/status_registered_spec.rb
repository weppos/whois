...
require 'spec_helper'
require 'whois/record/parser/whois.registry.gy.rb'

describe Whois::Record::Parser::WhoisRegistryGy, "status_registered.expected" do

  subject do
    file = fixture("responses", "whois.registry.gy/status_registered.txt")
  ...
  describe "#domain" do
    it do
      subject.domain.should == "google.gy"
    end
  end
  describe "#domain_id" do
    it do
      subject.domain_id.should == "573328-CoCCA"
    end
  end
  describe "#status" do
    it do
  ...
  describe "#created_on" do
    it do
      ...
      subject.created_on.should == Time.parse("2008-05-12 17:56:23 UTC")
    end
  end
  describe "#updated_on" do
    it do
      subject.updated_on.should be_a(Time)
      subject.updated_on.should == Time.parse("2012-10-15 08:36:53 UTC")
    end
  end
  describe "#expires_on" do
    it do
      subject.expires_on.should be_a(Time)
      subject.expires_on.should == Time.parse("2013-10-04 23:30:00 UTC")
    end
  end
