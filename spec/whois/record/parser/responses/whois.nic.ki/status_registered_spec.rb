...
describe Whois::Record::Parser::WhoisNicKi, "status_registered.expected" do
  ...
  describe "#domain" do
    it do
      subject.domain.should == "google.ki"
    end
  end
  describe "#domain_id" do
    it do
      subject.domain_id.should == "18030-CoCCA"
    end
  end
  describe "#status" do
    it do
  ...
  describe "#created_on" do
    it do
      ...
      subject.created_on.should == Time.parse("2006-05-15 12:00:00 UTC")
    end
  end
  describe "#updated_on" do
    it do
      subject.updated_on.should be_a(Time)
      subject.updated_on.should == Time.parse("2012-01-14 11:13:25 UTC")
    end
  end
