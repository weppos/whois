...
#
#   /spec/fixtures/responses/joburg-whois.registry.net.za/status_registered.expected
#
...
require 'spec_helper'
require 'whois/record/parser/joburg-whois.registry.net.za.rb'

describe Whois::Record::Parser::JoburgWhoisRegistryNetZa, "status_registered.expected" do

  subject do
    file = fixture("responses", "joburg-whois.registry.net.za/status_registered.txt")
