...
#
#   /spec/fixtures/responses/kero.yachay.pe/status_suspended.expected
#
...
describe Whois::Record::Parser::KeroYachayPe, "status_suspended.expected" do

  subject do
    file = fixture("responses", "kero.yachay.pe/status_suspended.txt")
