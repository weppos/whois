...
#
#   /spec/fixtures/responses/grs-whois.hichina.com/status_available.expected
#
...
describe Whois::Record::Parser::GrsWhoisHichinaCom, "status_available.expected" do

  subject do
    file = fixture("responses", "grs-whois.hichina.com/status_available.txt")
