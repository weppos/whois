...
describe Whois::Record::Parser::WhoisTwnicNetTw, "status_registered.expected" do
  ...
  describe "#created_on" do
    it do
      ...
      expect(subject.created_on).to eq(Time.parse("2000-08-29"))
    end
  end
  ...
  describe "#expires_on" do
    it do
      ...
      expect(subject.expires_on).to eq(Time.parse("2011-11-09"))
    end
  end
