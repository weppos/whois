...
require 'spec_helper'
require 'whois/record/parser/whois.gg.rb'

describe Whois::Record::Parser::WhoisGg, "status_available.expected" do

  subject do
    file = fixture("responses", "whois.gg/status_available.txt")
  ...
  describe "#domain" do
    it do
      subject.domain.should == "u34jedzcq.gg"
    end
  end
