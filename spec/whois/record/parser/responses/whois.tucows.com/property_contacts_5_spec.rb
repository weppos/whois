...
describe Whois::Record::Parser::WhoisTucowsCom, "property_contacts_5.expected" do
  ...
  describe "#admin_contacts" do
    it do
      ...
      @parser.admin_contacts[0].name.should         == "IT, Alpha"
      @parser.admin_contacts[0].organization.should == nil
      @parser.admin_contacts[0].address.should      == "1200 NE 112th Ave"
      @parser.admin_contacts[0].city.should         == "Vancouver"
      @parser.admin_contacts[0].zip.should          == "98684"
      @parser.admin_contacts[0].state.should        == "WA"
      @parser.admin_contacts[0].country_code.should == "US"
      @parser.admin_contacts[0].phone.should        == "(360) 885-4000"
      @parser.admin_contacts[0].fax.should          == nil
      @parser.admin_contacts[0].email.should        == "it@alphaecological.com"
    end
  end
end
