...
#
#   /spec/fixtures/responses/whois.nic.physio/status_available.expected
#
...
describe Whois::Record::Parser::WhoisNicPhysio, "status_available.expected" do

  subject do
    file = fixture("responses", "whois.nic.physio/status_available.txt")
