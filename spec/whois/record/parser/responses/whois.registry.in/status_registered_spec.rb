...
describe Whois::Record::Parser::WhoisRegistryIn, "status_registered.expected" do
  ...
  describe "#registrant_contacts" do
    it do
      ...
      @parser.registrant_contacts[0].city.should         == "Mountain View, CA"
      ...
      @parser.registrant_contacts[0].phone.should        == "+1.6503300100"
  ...
  describe "#admin_contacts" do
    it do
      ...
      @parser.admin_contacts[0].city.should         == "Mountain View, CA"
  ...
  describe "#technical_contacts" do
    it do
      ...
      @parser.technical_contacts[0].city.should         == "Mountain View, CA"
