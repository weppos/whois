...
describe Whois::Record::Parser::WhoisNc, "property_contact_without_state.expected" do
  ...
  describe "#registrant_contacts" do
    it do
      ...
      subject.registrant_contacts[0].name.should         == "PLAY NEW CALEDONIA"
      subject.registrant_contacts[0].organization.should == nil
      subject.registrant_contacts[0].address.should      == "12 BOULEVARD VAUBAN\nBP 2839"
      subject.registrant_contacts[0].city.should         == "NOUMEA CEDEX"
      subject.registrant_contacts[0].zip.should          == "98846"
