...
#
#   /spec/fixtures/responses/whois.crsnic.net/net/status_registered.expected
#
...
describe Whois::Record::Parser::WhoisCrsnicNet, "status_registered.expected" do
  ...
  subject do
    file = fixture("responses", "whois.crsnic.net/net/status_registered.txt")
  ...
  describe "#status" do
    it do
      subject.status.should == ["clientDeleteProhibited", "clientTransferProhibited", "clientUpdateProhibited", "serverDeleteProhibited", "serverTransferProhibited", "serverUpdateProhibited"]
    end
  end
  ...
  describe "#created_on" do
    it do
      ...
      subject.created_on.should == Time.parse("1999-03-15")
    end
  end
  describe "#updated_on" do
    it do
      subject.updated_on.should be_a(Time)
      subject.updated_on.should == Time.parse("2013-02-11")
    end
  end
  describe "#expires_on" do
    it do
      subject.expires_on.should be_a(Time)
      subject.expires_on.should == Time.parse("2014-03-15")
    end
  end
