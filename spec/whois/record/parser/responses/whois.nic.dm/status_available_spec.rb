...
#
#   /spec/fixtures/responses/whois.nic.dm/status_available.expected
#
...
describe Whois::Record::Parser::WhoisNicDm, "status_available.expected" do

  subject do
    file = fixture("responses", "whois.nic.dm/status_available.txt")
