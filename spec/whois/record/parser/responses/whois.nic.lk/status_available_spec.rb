...
#
#   /spec/fixtures/responses/whois.nic.lk/status_available.expected
#
...
describe Whois::Record::Parser::WhoisNicLk, "status_available.expected" do

  before(:each) do
    file = fixture("responses", "whois.nic.lk/status_available.txt")
