...
#
#   /spec/fixtures/responses/whois.registry.net.za/property_registrant_fax_empty.expected
#
...
describe Whois::Record::Parser::WhoisRegistryNetZa, "property_registrant_fax_empty.expected" do

  subject do
    file = fixture("responses", "whois.registry.net.za/property_registrant_fax_empty.txt")
