...
#
#   /spec/fixtures/responses/whois.nic.xyz/status_registered.expected
#
...
require 'spec_helper'
require 'whois/record/parser/whois.nic.xyz.rb'

describe Whois::Record::Parser::WhoisNicXyz, "status_registered.expected" do

  subject do
    file = fixture("responses", "whois.nic.xyz/status_registered.txt")
  ...
  describe "#updated_on" do
    it do
      ...
      expect(subject.updated_on).to eq(Time.parse("2015-08-18 15:09:36 UTC"))
    end
  end
