...
#
#   /spec/fixtures/responses/whois.nic.xyz/status_available.expected
#
...
describe Whois::Record::Parser::WhoisNicXyz, "status_available.expected" do

  subject do
    file = fixture("responses", "whois.nic.xyz/status_available.txt")
