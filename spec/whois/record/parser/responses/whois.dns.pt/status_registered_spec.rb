...
describe Whois::Record::Parser::WhoisDnsPt, "status_registered.expected" do
  ...
  describe "#created_on" do
    it do
      ...
      expect(subject.created_on).to eq(Time.parse("2003-01-09 00:00:00 UTC"))
    end
  end
  ...
  describe "#expires_on" do
    it do
      ...
      expect(subject.expires_on).to eq(Time.parse("2015-02-28 00:00:00 UTC"))
    end
  end
