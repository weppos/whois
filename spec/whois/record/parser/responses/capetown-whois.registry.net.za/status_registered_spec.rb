...
#
#   /spec/fixtures/responses/capetown-whois.registry.net.za/status_registered.expected
#
...
describe Whois::Record::Parser::CapetownWhoisRegistryNetZa, "status_registered.expected" do
  ...
  subject do
    file = fixture("responses", "capetown-whois.registry.net.za/status_registered.txt")
