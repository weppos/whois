...
require 'spec_helper'
require 'whois/record/parser/whois.nic.ci.rb'

describe Whois::Record::Parser::WhoisNicCi, "status_registered.expected" do
  ...
  describe "#created_on" do
    it do
      ...
      subject.created_on.should == Time.parse("2006-01-27 11:14:47.77")
    end
  end
  ...
  describe "#expires_on" do
    it do
      ...
      subject.expires_on.should == Time.parse("2013-02-13 11:14:47.77")
    end
  end
