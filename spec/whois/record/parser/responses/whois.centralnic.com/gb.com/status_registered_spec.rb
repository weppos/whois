...
describe Whois::Record::Parser::WhoisCentralnicCom, "status_registered.expected" do
  ...
  describe "#updated_on" do
    it do
      ...
      subject.updated_on.should == Time.parse("2011-08-09 00:17:05 UTC")
    end
  end
  describe "#expires_on" do
    it do
      subject.expires_on.should be_a(Time)
      subject.expires_on.should == Time.parse("2012-04-23 23:59:59 UTC")
    end
  end
  ...
  describe "#nameservers" do
    it do
      ...
      subject.nameservers[1].name.should == "c.ns14.net"
      subject.nameservers[2].should be_a(Whois::Record::Nameserver)
      subject.nameservers[2].name.should == "b.ns14.net"
      subject.nameservers[3].should be_a(Whois::Record::Nameserver)
      subject.nameservers[3].name.should == "a.ns14.net"
    end
  end
end
