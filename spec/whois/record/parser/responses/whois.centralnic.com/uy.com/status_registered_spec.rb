...
describe Whois::Record::Parser::WhoisCentralnicCom, "status_registered.expected" do
  ...
  describe "#domain" do
    it do
      @parser.domain.should == "bestb.uy.com"
    end
  end
  describe "#domain_id" do
    it do
      @parser.domain_id.should == "CNIC-DO493832"
    end
  end
  ...
  describe "#created_on" do
    it do
      ...
      @parser.created_on.should == Time.parse("2007-07-12 13:49:25 UTC")
    end
  end
  describe "#updated_on" do
    it do
      @parser.updated_on.should be_a(Time)
      @parser.updated_on.should == Time.parse("2011-07-13 10:57:04 UTC")
    end
  end
  describe "#expires_on" do
    it do
      @parser.expires_on.should be_a(Time)
      @parser.expires_on.should == Time.parse("2013-07-12 23:59:59 UTC")
    end
  end
  ...
  describe "#registrant_contacts" do
    it do
      ...
      @parser.registrant_contacts[0].id.should            == "H1090697"
      @parser.registrant_contacts[0].name.should          == "directfromowner"
      @parser.registrant_contacts[0].organization.should  == nil
      @parser.registrant_contacts[0].address.should       == "Christopher Court\nLeeds\nYorkshire"
      @parser.registrant_contacts[0].city.should          == nil
      @parser.registrant_contacts[0].zip.should           == "LS6 2JX"
      ...
      @parser.registrant_contacts[0].phone.should         == "+44.7733410198"
      @parser.registrant_contacts[0].fax.should           == nil
      @parser.registrant_contacts[0].email.should         == "biznesinternet@hotmail.com"
    end
  end
  describe "#admin_contacts" do
    it do
      ...
      @parser.admin_contacts[0].id.should            == "H314291"
      @parser.admin_contacts[0].name.should          == "Pageny Nikolova"
      @parser.admin_contacts[0].organization.should  == "directfromowner"
      @parser.admin_contacts[0].address.should       == "Christopher Court\nLeeds\nYorkshire"
      @parser.admin_contacts[0].city.should          == nil
      @parser.admin_contacts[0].zip.should           == "LS6 2JX"
      ...
      @parser.admin_contacts[0].phone.should         == "+44.7733410198"
      @parser.admin_contacts[0].fax.should           == nil
      @parser.admin_contacts[0].email.should         == "biznesinternet@hotmail.com"
    end
  end
  ...
  describe "#nameservers" do
    it do
      ...
      @parser.nameservers[0].name.should == "ns2.123-reg.co.uk"
      @parser.nameservers[1].should be_a(Whois::Record::Nameserver)
      @parser.nameservers[1].name.should == "ns.123-reg.co.uk"
    end
  end
end
