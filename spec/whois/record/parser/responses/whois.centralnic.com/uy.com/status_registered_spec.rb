...
describe Whois::Record::Parser::WhoisCentralnicCom, "status_registered.expected" do
  ...
  describe "#domain" do
    it do
      expect(subject.domain).to eq("bestb.uy.com")
    end
  end
  describe "#domain_id" do
    it do
      expect(subject.domain_id).to eq("CNIC-DO493832")
    end
  end
  describe "#status" do
    it do
  ...
  describe "#created_on" do
    it do
      ...
      expect(subject.created_on).to eq(Time.parse("2007-07-12 13:49:25 UTC"))
    end
  end
  describe "#updated_on" do
    it do
      expect(subject.updated_on).to be_a(Time)
      expect(subject.updated_on).to eq(Time.parse("2013-07-10 00:27:20 UTC"))
    end
  end
  describe "#expires_on" do
    it do
      expect(subject.expires_on).to be_a(Time)
      expect(subject.expires_on).to eq(Time.parse("2015-07-12 23:59:59 UTC"))
    end
  end
  ...
  describe "#registrant_contacts" do
    it do
      ...
      expect(subject.registrant_contacts[0].id).to eq("MNT32524959440")
      ...
      expect(subject.registrant_contacts[0].email).to eq("bestb.uy.com@identity-protect.org")
    end
  end
  describe "#admin_contacts" do
    it do
      ...
      expect(subject.admin_contacts[0].id).to eq("MNT32524959440")
      ...
      expect(subject.admin_contacts[0].email).to eq("bestb.uy.com@identity-protect.org")
    end
  end
  describe "#technical_contacts" do
    it do
      ...
      expect(subject.technical_contacts[0].id).to eq("MNT32524959440")
      ...
      expect(subject.technical_contacts[0].email).to eq("bestb.uy.com@identity-protect.org")
    end
  end
  describe "#nameservers" do
    it do
      ...
      expect(subject.nameservers[0].name).to eq("ns2.123-reg.co.uk")
      expect(subject.nameservers[1]).to be_a(Whois::Record::Nameserver)
      expect(subject.nameservers[1].name).to eq("ns.123-reg.co.uk")
    end
  end
end
