...
describe Whois::Record::Parser::WhoisCentralnicCom, "status_registered.expected" do
  ...
  describe "#domain" do
    it do
      expect(subject.domain).to eq("koi.jpn.com")
    end
  end
  describe "#domain_id" do
    it do
      expect(subject.domain_id).to eq("CNIC-DO492866")
    end
  end
  describe "#status" do
    it do
  ...
  describe "#created_on" do
    it do
      ...
      expect(subject.created_on).to eq(Time.parse("2007-06-29 13:42:35 UTC"))
    end
  end
  ...
  describe "#expires_on" do
    it do
      ...
      expect(subject.expires_on).to eq(Time.parse("2015-06-29 23:59:59 UTC"))
    end
  end
  ...
  describe "#registrant_contacts" do
    it do
      ...
      expect(subject.registrant_contacts[0].id).to eq("MNT78E22765897")
      ...
      expect(subject.registrant_contacts[0].email).to eq("koi.jpn.com@identity-protect.org")
    end
  end
  describe "#admin_contacts" do
    it do
      ...
      expect(subject.admin_contacts[0].id).to eq("MNT78E22765897")
      ...
      expect(subject.admin_contacts[0].email).to eq("koi.jpn.com@identity-protect.org")
    end
  end
  describe "#technical_contacts" do
    it do
      ...
      expect(subject.technical_contacts[0].id).to eq("MNT78E22765897")
      ...
      expect(subject.technical_contacts[0].email).to eq("koi.jpn.com@identity-protect.org")
    end
  end
