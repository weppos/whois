...
describe Whois::Record::Parser::WhoisCentralnicCom, "status_registered.expected" do
  ...
  describe "#updated_on" do
    it do
      ...
      subject.updated_on.should == Time.parse("2012-07-11 08:05:30 UTC")
    end
  end
  describe "#expires_on" do
    it do
      subject.expires_on.should be_a(Time)
      subject.expires_on.should == Time.parse("2013-05-10 23:59:59 UTC")
    end
  end
  ...
  describe "#nameservers" do
    it do
      ...
      subject.nameservers[0].name.should == "ns2.surfbrett.de"
      subject.nameservers[1].should be_a(Whois::Record::Nameserver)
      subject.nameservers[1].name.should == "ns2.hrs.de"
      subject.nameservers[2].should be_a(Whois::Record::Nameserver)
      subject.nameservers[2].name.should == "ns1.hrs.de"
    end
  end
end
