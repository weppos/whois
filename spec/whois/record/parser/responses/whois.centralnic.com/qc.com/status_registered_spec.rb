...
describe Whois::Record::Parser::WhoisCentralnicCom, "status_registered.expected" do
  ...
  describe "#domain" do
    it do
      subject.domain.should == "ceo.qc.com"
    end
  end
  describe "#domain_id" do
    it do
      subject.domain_id.should == "CNIC-DO327026"
    end
  end
  ...
  describe "#created_on" do
    it do
      ...
      subject.created_on.should == Time.parse("2004-10-08 02:12:49 UTC")
    end
  end
  describe "#updated_on" do
    it do
      subject.updated_on.should be_a(Time)
      subject.updated_on.should == Time.parse("2010-10-11 17:18:17 UTC")
    end
  end
  describe "#expires_on" do
    it do
      subject.expires_on.should be_a(Time)
      subject.expires_on.should == Time.parse("2012-10-08 23:59:59 UTC")
    end
  end
  ...
  describe "#registrant_contacts" do
    it do
      ...
      subject.registrant_contacts[0].phone.should         == "+1.8198438380"
      subject.registrant_contacts[0].fax.should           == nil
      subject.registrant_contacts[0].email.should         == "docjgs@videotron.ca"
    end
  end
  describe "#admin_contacts" do
    it do
      ...
      subject.admin_contacts[0].phone.should         == "+1.8198438380"
      subject.admin_contacts[0].fax.should           == nil
      subject.admin_contacts[0].email.should         == "docjgs@videotron.ca"
    end
  end
  describe "#technical_contacts" do
    it do
      ...
      subject.technical_contacts[0].phone.should         == "+1.8198438380"
      subject.technical_contacts[0].fax.should           == nil
      subject.technical_contacts[0].email.should         == "docjgs@videotron.ca"
    end
  end
