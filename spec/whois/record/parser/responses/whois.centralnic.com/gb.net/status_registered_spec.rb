...
describe Whois::Record::Parser::WhoisCentralnicCom, "status_registered.expected" do
  ...
  describe "#domain_id" do
    it do
      subject.domain_id.should == "CNIC-DO605873"
    end
  end
  ...
  describe "#created_on" do
    it do
      ...
      subject.created_on.should == Time.parse("2008-12-04 05:56:57 UTC")
    end
  end
  describe "#updated_on" do
    it do
      subject.updated_on.should be_a(Time)
      subject.updated_on.should == Time.parse("2011-12-04 12:00:12 UTC")
    end
  end
  describe "#expires_on" do
    it do
      subject.expires_on.should be_a(Time)
      subject.expires_on.should == Time.parse("2011-12-04 23:59:59 UTC")
    end
  end
  ...
  describe "#registrant_contacts" do
    it do
      ...
      subject.registrant_contacts[0].id.should            == "INX-9925147net"
  ...
  describe "#admin_contacts" do
    it do
      ...
      subject.admin_contacts[0].id.should            == "INX-9925147net"
  ...
  describe "#technical_contacts" do
    it do
      ...
      subject.technical_contacts[0].id.should            == "INX-9925147net"
  ...
  describe "#nameservers" do
    it do
      ...
      subject.nameservers[0].name.should == "d.ns14.net"
      ...
      subject.nameservers[3].name.should == "b.ns14.net"
    end
  end
end
