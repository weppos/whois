...
describe Whois::Record::Parser::WhoisCentralnicCom, "status_registered.expected" do
  ...
  describe "#domain" do
    it do
      @parser.domain.should == "gsn.cn.com"
    end
  end
  describe "#domain_id" do
    it do
      @parser.domain_id.should == "CNIC-DO323367"
    end
  end
  ...
  describe "#created_on" do
    it do
      ...
      @parser.created_on.should == Time.parse("2005-11-23 15:44:03 UTC")
    end
  end
  describe "#updated_on" do
    it do
      @parser.updated_on.should be_a(Time)
      @parser.updated_on.should == Time.parse("2011-12-05 10:25:41 UTC")
    end
  end
  describe "#expires_on" do
    it do
      @parser.expires_on.should be_a(Time)
      @parser.expires_on.should == Time.parse("2012-11-23 23:59:59 UTC")
    end
  end
  describe "#registrar" do
    it do
      @parser.registrar.should be_a(Whois::Record::Registrar)
      @parser.registrar.id.should           == "H67436"
      @parser.registrar.name.should         == nil
      @parser.registrar.organization.should == "United Domains AG"
      @parser.registrar.url.should          == "http://www.united-domains.de"
    end
  end
  describe "#registrant_contacts" do
    it do
      ...
      @parser.registrant_contacts[0].id.should            == "H1062079"
      @parser.registrant_contacts[0].name.should          == "GSN Electronics Incorporation Pte Ltd"
      ...
      @parser.registrant_contacts[0].zip.should           == "049910"
      @parser.registrant_contacts[0].state.should         == nil
      @parser.registrant_contacts[0].country.should       == nil
      @parser.registrant_contacts[0].country_code.should  == "SG"
      @parser.registrant_contacts[0].phone.should         == "+65.62336919"
      @parser.registrant_contacts[0].fax.should           == nil
      @parser.registrant_contacts[0].email.should         == "abuse@gsn.in"
    end
  end
  describe "#admin_contacts" do
    it do
      ...
      @parser.admin_contacts[0].id.should            == "H161687"
      @parser.admin_contacts[0].name.should          == "Pauline Ang"
      @parser.admin_contacts[0].organization.should  == "GSN Electronics Incorporation Pte Ltd"
      @parser.admin_contacts[0].address.should       == nil
      @parser.admin_contacts[0].city.should          == nil
      @parser.admin_contacts[0].zip.should           == "049910"
      @parser.admin_contacts[0].state.should         == nil
      @parser.admin_contacts[0].country.should       == nil
      @parser.admin_contacts[0].country_code.should  == "SG"
      @parser.admin_contacts[0].phone.should         == "+65.62336919"
      @parser.admin_contacts[0].fax.should           == nil
      @parser.admin_contacts[0].email.should         == "abuse@gsn.in"
    end
  end
  describe "#technical_contacts" do
    it do
      ...
      @parser.technical_contacts[0].id.should            == "H94152"
  ...
  describe "#nameservers" do
    it do
      ...
      @parser.nameservers[0].name.should == "ns1.meteos.it"
      @parser.nameservers[1].should be_a(Whois::Record::Nameserver)
      @parser.nameservers[1].name.should == "ns2.meteos.it"
    end
  end
end
