...
describe Whois::Record::Parser::WhoisNicNetSb, "status_available.expected" do

  subject do
    file = fixture("responses", "whois.nic.net.sb/status_available.txt")
  ...
  describe "#domain" do
    it do
      subject.domain.should == "u34jedzcq.sb"
    end
  end
