...
describe Whois::Record::Parser::WhoisNicCc, "status_registered.expected" do
  ...
  describe "#domain_id" do
    it do
      subject.domain_id.should == "86420657"
    end
  end
  describe "#status" do
    it do
      subject.status.should == ["CLIENT-DELETE-PROHIBITED", "CLIENT-UPDATE-PROHIBITED", "CLIENT-XFER-PROHIBITED", "SERVER-DELETE-PROHIBITED", "SERVER-UPDATE-PROHIBITED", "SERVER-XFER-PROHIBITED"]
    end
  end
  ...
  describe "#created_on" do
    it do
      ...
      subject.created_on.should == Time.parse("1999-06-07 00:00:00 UTC")
    end
  end
  describe "#updated_on" do
    it do
      subject.updated_on.should be_a(Time)
      subject.updated_on.should == Time.parse("2013-05-06 05:17:44 UTC")
    end
  end
  describe "#expires_on" do
    it do
      subject.expires_on.should be_a(Time)
      subject.expires_on.should == Time.parse("2014-06-07 00:00:00 UTC")
    end
  end
