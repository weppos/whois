...
#
#   /spec/fixtures/responses/whois.dotproregistry.net/pro/status_registered.expected
#
...
require 'spec_helper'
require 'whois/record/parser/whois.dotproregistry.net.rb'

describe Whois::Record::Parser::WhoisDotproregistryNet, "status_registered.expected" do

  subject do
    file = fixture("responses", "whois.dotproregistry.net/pro/status_registered.txt")
  ...
  describe "#domain_id" do
    it do
      expect(subject.domain_id).to eq("D11545-PRO")
    end
  end
  describe "#status" do
    it do
  ...
  describe "#updated_on" do
    it do
      ...
      expect(subject.updated_on).to eq(Time.parse("2013-08-07 09:18:18 UTC"))
    end
  end
  describe "#expires_on" do
    it do
      expect(subject.expires_on).to be_a(Time)
      expect(subject.expires_on).to eq(Time.parse("2014-09-08 00:00:00 UTC"))
    end
  end
  describe "#registrar" do
    it do
      expect(subject.registrar).to be_a(Whois::Record::Registrar)
      expect(subject.registrar.id).to eq("R2341-PRO")
  ...
  describe "#registrant_contacts" do
    it do
      ...
      expect(subject.registrant_contacts[0].id).to eq("google")
  ...
  describe "#admin_contacts" do
    it do
      ...
      expect(subject.admin_contacts[0].id).to eq("google")
  ...
  describe "#technical_contacts" do
    it do
      ...
      expect(subject.technical_contacts[0].id).to eq("google")
