...
describe Whois::Record::Parser::WhoisNicFr, "status_registered.expected" do
  ...
  describe "#created_on" do
    it do
      ...
      subject.created_on.should == Time.parse("2004-10-26")
    end
  end
  describe "#updated_on" do
    it do
      subject.updated_on.should be_a(Time)
      subject.updated_on.should == Time.parse("2004-10-29")
    end
  end
  ...
  describe "#registrant_contacts" do
    it do
      ...
      subject.registrant_contacts[0].id.should            == "AAEA9-FRNIC"
      subject.registrant_contacts[0].name.should          == nil
      subject.registrant_contacts[0].organization.should  == "Afnic (Terres Australes et Antarctiques - TOM)"
