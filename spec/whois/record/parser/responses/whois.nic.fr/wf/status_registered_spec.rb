...
describe Whois::Record::Parser::WhoisNicFr, "status_registered.expected" do
  ...
  before(:each) do
    file = fixture("responses", "whois.nic.fr/wf/status_registered.txt")
  ...
  describe "#registrant_contacts" do
    it do
      ...
      @parser.registrant_contacts[0].id.should            == "AEFT2-FRNIC"
      @parser.registrant_contacts[0].name.should          == nil
      @parser.registrant_contacts[0].organization.should  == "Afnic (Wallis et Futuna - TOM)"
      ...
      @parser.registrant_contacts[0].updated_on.should    == Time.parse("2008-10-09")
    end
  end
