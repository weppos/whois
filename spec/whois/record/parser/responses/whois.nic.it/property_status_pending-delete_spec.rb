...
describe Whois::Record::Parser::WhoisNicIt, "property_status_pending-delete.expected" do

  subject do
    file = fixture("responses", "whois.nic.it/property_status_pending-delete.txt")
