...
#
#   /spec/fixtures/responses/whois.iis.se/status_available.expected
#
...
describe Whois::Record::Parser::WhoisIisSe, "status_available.expected" do

  subject do
    file = fixture("responses", "whois.iis.se/status_available.txt")
