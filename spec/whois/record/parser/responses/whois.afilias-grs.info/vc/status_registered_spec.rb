...
describe Whois::Record::Parser::WhoisAfiliasGrsInfo, "status_registered.expected" do
  ...
  describe "#domain_id" do
    it do
      expect(subject.domain_id).to eq("D133753-LRCC")
    end
  end
  describe "#status" do
    it do
  ...
  describe "#created_on" do
    it do
      ...
      expect(subject.created_on).to eq(Time.parse("2005-06-29 00:58:18 UTC"))
    end
  end
  describe "#updated_on" do
    it do
      expect(subject.updated_on).to be_a(Time)
      expect(subject.updated_on).to eq(Time.parse("2009-02-17 17:43:40 UTC"))
    end
  end
  describe "#expires_on" do
    it do
      expect(subject.expires_on).to be_a(Time)
      expect(subject.expires_on).to eq(Time.parse("2011-06-29 00:58:18 UTC"))
    end
  end
