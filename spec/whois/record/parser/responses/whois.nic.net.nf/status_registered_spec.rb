...
describe Whois::Record::Parser::WhoisNicNetNf, "status_registered.expected" do

  subject do
    file = fixture("responses", "whois.nic.net.nf/status_registered.txt")
  ...
  describe "#domain" do
    it do
      subject.domain.should == "google.nf"
    end
  end
  describe "#domain_id" do
    it do
      subject.domain_id.should == "26552-CoCCA"
    end
  end
  describe "#status" do
    it do
  ...
  describe "#created_on" do
    it do
      ...
      subject.created_on.should == Time.parse("2005-11-27 11:00:00 UTC")
    end
  end
  describe "#updated_on" do
    it do
      subject.updated_on.should be_a(Time)
      subject.updated_on.should == Time.parse("2012-01-14 11:14:40 UTC")
    end
  end
  describe "#expires_on" do
    it do
      subject.expires_on.should be_a(Time)
      subject.expires_on.should == Time.parse("2012-11-27 11:00:00 UTC")
    end
  end
