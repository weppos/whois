...
#
#   /spec/fixtures/responses/whois.tld.sy/status_available.expected
#
...
describe Whois::Record::Parser::WhoisTldSy, "status_available.expected" do

  subject do
    file = fixture("responses", "whois.tld.sy/status_available.txt")
  ...
  describe "#domain" do
    it do
      subject.domain.should == "u34jedzcq.sy"
    end
  end
