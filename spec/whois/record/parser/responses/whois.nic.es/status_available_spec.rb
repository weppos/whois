...
#
#   /spec/fixtures/responses/whois.nic.es/status_available.expected
#
...
describe Whois::Record::Parser::WhoisNicEs, "status_available.expected" do

  subject do
    file = fixture("responses", "whois.nic.es/status_available.txt")
