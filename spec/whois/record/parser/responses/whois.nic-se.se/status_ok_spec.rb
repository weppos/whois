...
#
#   /spec/fixtures/responses/whois.nic-se.se/status_ok.expected
#
...
describe Whois::Record::Parser::WhoisNicSeSe, "status_ok.expected" do

  subject do
    file = fixture("responses", "whois.nic-se.se/status_ok.txt")
