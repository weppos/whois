...
describe Whois::Record::Parser::WhoisNicSeSe, "status_registered.expected" do
  ...
  describe "#updated_on" do
    it do
      ...
      expect(subject.updated_on).to eq(Time.parse("2009-08-01"))
    end
  end
  describe "#expires_on" do
    it do
      expect(subject.expires_on).to be_a(Time)
      expect(subject.expires_on).to eq(Time.parse("2010-10-20"))
    end
  end
  ...
  describe "#registrant_contacts" do
    it do
      ...
      expect(subject.registrant_contacts[0].id).to eq("googoo5855-00001")
