...
require 'spec_helper'
require 'whois/record/parser/whois.nic.ec.rb'

describe Whois::Record::Parser::WhoisNicEc, "status_registered.expected" do
  ...
  describe "#created_on" do
    it do
      ...
      subject.created_on.should == Time.parse("2003-10-16")
    end
  end
  describe "#updated_on" do
    it do
      subject.updated_on.should be_a(Time)
      subject.updated_on.should == Time.parse("2009-09-15")
    end
  end
