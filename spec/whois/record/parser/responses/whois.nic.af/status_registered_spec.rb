...
describe Whois::Record::Parser::WhoisNicAf, "status_registered.expected" do
  ...
  describe "#domain" do
    it do
      subject.domain.should == "google.af"
    end
  end
  describe "#domain_id" do
    it do
      subject.domain_id.should == "345679-CoCCA"
    end
  end
  describe "#status" do
    it do
  ...
  describe "#created_on" do
    it do
      ...
      subject.created_on.should == Time.parse("2009-10-05 03:51:17 UTC")
    end
  end
  describe "#updated_on" do
    it do
      subject.updated_on.should be_a(Time)
      subject.updated_on.should == Time.parse("2012-04-30 14:49:02 UTC")
    end
  end
  describe "#expires_on" do
    it do
      subject.expires_on.should be_a(Time)
      subject.expires_on.should == Time.parse("2013-05-05 03:51:17 UTC")
    end
  end
