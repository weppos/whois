...
#
#   /spec/fixtures/responses/whois.nic.tech/status_registered.expected
#
...
require 'spec_helper'
require 'whois/record/parser/whois.nic.tech.rb'

describe Whois::Record::Parser::WhoisNicTech, "status_registered.expected" do

  subject do
    file = fixture("responses", "whois.nic.tech/status_registered.txt")
