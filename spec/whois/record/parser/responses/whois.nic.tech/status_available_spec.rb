...
#
#   /spec/fixtures/responses/whois.nic.tech/status_available.expected
#
...
describe Whois::Record::Parser::WhoisNicTech, "status_available.expected" do

  subject do
    file = fixture("responses", "whois.nic.tech/status_available.txt")
