...
describe Whois::Record::Parser::WhoisNicUk, "property_status_no_status_listed.expected" do

  subject do
    file = fixture("responses", "whois.nic.uk/property_status_no_status_listed.txt")
