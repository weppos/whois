...
#
#   /spec/fixtures/responses/whois.iis.nu/status_registered.expected
#
...
describe Whois::Record::Parser::WhoisIisNu, "status_registered.expected" do
  ...
  subject do
    file = fixture("responses", "whois.iis.nu/status_registered.txt")
  ...
  describe "#updated_on" do
    it do
      ...
      expect(subject.updated_on).to eq(Time.parse("2013-09-18"))
    end
  end
  describe "#expires_on" do
    it do
      expect(subject.expires_on).to be_a(Time)
      expect(subject.expires_on).to eq(Time.parse("2014-06-07"))
    end
  end
