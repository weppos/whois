...
#
#   /spec/fixtures/responses/whois.nic.pw/status_available.expected
#
...
describe Whois::Record::Parser::WhoisNicPw, "status_available.expected" do

  subject do
    file = fixture("responses", "whois.nic.pw/status_available.txt")
