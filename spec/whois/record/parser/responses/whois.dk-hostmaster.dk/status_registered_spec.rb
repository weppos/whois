...
describe Whois::Record::Parser::WhoisDkHostmasterDk, "status_registered.expected" do
  ...
  describe "#created_on" do
    it do
      ...
      subject.created_on.should == Time.parse("1999-01-10")
    end
  end
  ...
  describe "#expires_on" do
    it do
      ...
      subject.expires_on.should == Time.parse("2010-03-31")
    end
  end
