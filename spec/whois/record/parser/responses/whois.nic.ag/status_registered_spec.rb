...
describe Whois::Record::Parser::WhoisNicAg, "status_registered.expected" do
  ...
  describe "#domain" do
    it do
      subject.domain.should == "google.ag"
    end
  end
  describe "#domain_id" do
    it do
      subject.domain_id.should == "D48552-LRCC"
    end
  end
  describe "#status" do
    it do
  ...
  describe "#created_on" do
    it do
      ...
      subject.created_on.should == Time.parse("2003-01-05 14:06:59 UTC")
    end
  end
  describe "#updated_on" do
    it do
      subject.updated_on.should be_a(Time)
      subject.updated_on.should == Time.parse("2009-12-09 19:28:04 UTC")
    end
  end
  describe "#expires_on" do
    it do
      subject.expires_on.should be_a(Time)
      subject.expires_on.should == Time.parse("2011-01-05 14:06:59 UTC")
    end
  end
  ...
  describe "#admin_contacts" do
    it do
      ...
      subject.admin_contacts[0].id.should           == "AGRS-129819"
  ...
  describe "#technical_contacts" do
    it do
      ...
      subject.technical_contacts[0].id.should           == "AGRS-129819"
