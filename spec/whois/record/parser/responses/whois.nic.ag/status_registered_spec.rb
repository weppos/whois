...
require 'spec_helper'
require 'whois/record/parser/whois.nic.ag.rb'

describe Whois::Record::Parser::WhoisNicAg, "status_registered.expected" do

  before(:each) do
    file = fixture("responses", "whois.nic.ag/status_registered.txt")
  ...
  describe "#domain" do
    it do
      @parser.domain.should == "google.ag"
    end
  end
  describe "#domain_id" do
    it do
      @parser.domain_id.should == "D48552-LRCC"
    end
  end
  ...
  describe "#created_on" do
    it do
      ...
      @parser.created_on.should == Time.parse("2003-01-05 14:06:59 UTC")
    end
  end
  describe "#updated_on" do
    it do
      @parser.updated_on.should be_a(Time)
      @parser.updated_on.should == Time.parse("2009-12-09 19:28:04 UTC")
    end
  end
  describe "#expires_on" do
    it do
      @parser.expires_on.should be_a(Time)
      @parser.expires_on.should == Time.parse("2011-01-05 14:06:59 UTC")
    end
  end
  ...
  describe "#admin_contacts" do
    it do
      ...
      @parser.admin_contacts[0].id.should           == "AGRS-129819"
  ...
  describe "#technical_contacts" do
    it do
      ...
      @parser.technical_contacts[0].id.should           == "AGRS-129819"
