...
describe Whois::Record::Parser::WhoisNicAg, "status_registered.expected" do
  ...
  describe "#domain_id" do
    it do
      expect(subject.domain_id).to eq("D48552-LRCC")
    end
  end
  describe "#status" do
    it do
  ...
  describe "#created_on" do
    it do
      ...
      expect(subject.created_on).to eq(Time.parse("2003-01-05 14:06:59 UTC"))
    end
  end
  ...
  describe "#admin_contacts" do
    it do
      ...
      expect(subject.admin_contacts[0].id).to eq("AGRS-129819")
  ...
  describe "#technical_contacts" do
    it do
      ...
      expect(subject.technical_contacts[0].id).to eq("AGRS-129819")
