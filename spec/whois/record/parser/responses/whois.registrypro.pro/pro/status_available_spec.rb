...
#
#   /spec/fixtures/responses/whois.registrypro.pro/pro/status_available.expected
#
...
describe Whois::Record::Parser::WhoisRegistryproPro, "status_available.expected" do

  subject do
    file = fixture("responses", "whois.registrypro.pro/pro/status_available.txt")
