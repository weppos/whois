...
#
#   /spec/fixtures/responses/whois.nic.fo/status_available.expected
#
...
describe Whois::Record::Parser::WhoisNicFo, "status_available.expected" do

  subject do
    file = fixture("responses", "whois.nic.fo/status_available.txt")
