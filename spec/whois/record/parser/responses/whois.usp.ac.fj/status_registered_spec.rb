...
require 'spec_helper'
require 'whois/record/parser/whois.usp.ac.fj.rb'

describe Whois::Record::Parser::WhoisUspAcFj, "status_registered.expected" do
  ...
  describe "#expires_on" do
    it do
      ...
      subject.expires_on.should == Time.parse("2011-04-28")
    end
  end
