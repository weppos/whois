...
#
#   /spec/fixtures/responses/whois.denic.de/status_available.expected
#
...
describe Whois::Record::Parser::WhoisDenicDe, "status_available.expected" do
  ...
  subject do
    file = fixture("responses", "whois.denic.de/status_available.txt")
  ...
  describe "#domain" do
    it do
      subject.domain.should == "googlededewdedewdewde.de"
    end
  end
