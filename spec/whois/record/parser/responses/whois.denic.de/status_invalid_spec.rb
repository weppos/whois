...
#
#   /spec/fixtures/responses/whois.denic.de/status_invalid.expected
#
...
describe Whois::Record::Parser::WhoisDenicDe, "status_invalid.expected" do
  ...
  subject do
    file = fixture("responses", "whois.denic.de/status_invalid.txt")
  ...
  describe "#domain" do
    it do
      subject.domain.should == "googlededewdedewdewde.foo.de"
    end
  end
