...
describe Whois::Record::Parser::WhoisRegisterBg, "status_registered.expected" do
  ...
  describe "#created_on" do
    it do
      ...
      expect(subject.created_on).to eq(Time.parse("2003-06-30 00:00:00"))
    end
  end
  ...
  describe "#expires_on" do
    it do
      ...
      expect(subject.expires_on).to eq(Time.parse("2014-06-30 00:00:00"))
    end
  end
