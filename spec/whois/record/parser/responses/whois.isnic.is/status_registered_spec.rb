...
describe Whois::Record::Parser::WhoisIsnicIs, "status_registered.expected" do
  ...
  describe "#created_on" do
    it do
      ...
      subject.created_on.should == Time.parse("2002-05-22")
    end
  end
  ...
  describe "#expires_on" do
    it do
      ...
      subject.expires_on.should == Time.parse("2010-05-22")
    end
  end
