...
#
#   /spec/fixtures/responses/whois.nic.asia/status_reserved.expected
#
...
describe Whois::Record::Parser::WhoisNicAsia, "status_reserved.expected" do

  subject do
    file = fixture("responses", "whois.nic.asia/status_reserved.txt")
