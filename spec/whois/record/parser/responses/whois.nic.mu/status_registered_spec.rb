...
describe Whois::Record::Parser::WhoisNicMu, "status_registered.expected" do
  ...
  describe "#domain" do
    it do
      subject.domain.should == "google.mu"
    end
  end
  describe "#domain_id" do
    it do
      subject.domain_id.should == "70557-CoCCA"
    end
  end
  describe "#status" do
    it do
  ...
  describe "#created_on" do
    it do
      ...
      subject.created_on.should == Time.parse("2000-12-20 13:00:00 UTC")
    end
  end
  describe "#updated_on" do
    it do
      subject.updated_on.should be_a(Time)
      subject.updated_on.should == Time.parse("2012-11-17 20:14:57 UTC")
    end
  end
  describe "#expires_on" do
    it do
      subject.expires_on.should be_a(Time)
      subject.expires_on.should == Time.parse("2013-12-19 13:00:00 UTC")
    end
  end
