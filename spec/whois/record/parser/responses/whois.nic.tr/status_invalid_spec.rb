...
#
#   /spec/fixtures/responses/whois.nic.tr/status_invalid.expected
#
...
describe Whois::Record::Parser::WhoisNicTr, "status_invalid.expected" do

  subject do
    file = fixture("responses", "whois.nic.tr/status_invalid.txt")
