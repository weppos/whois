...
#
#   /spec/fixtures/responses/durban-whois.registry.net.za/status_registered.expected
#
...
describe Whois::Record::Parser::DurbanWhoisRegistryNetZa, "status_registered.expected" do
  ...
  subject do
    file = fixture("responses", "durban-whois.registry.net.za/status_registered.txt")
