...
#
#   /spec/fixtures/responses/durban-whois.registry.net.za/status_available.expected
#
...
describe Whois::Record::Parser::DurbanWhoisRegistryNetZa, "status_available.expected" do
  ...
  subject do
    file = fixture("responses", "durban-whois.registry.net.za/status_available.txt")
