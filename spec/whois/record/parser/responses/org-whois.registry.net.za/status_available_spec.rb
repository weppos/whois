...
#
#   /spec/fixtures/responses/org-whois.registry.net.za/status_available.expected
#
...
describe Whois::Record::Parser::OrgWhoisRegistryNetZa, "status_available.expected" do

  subject do
    file = fixture("responses", "org-whois.registry.net.za/status_available.txt")
