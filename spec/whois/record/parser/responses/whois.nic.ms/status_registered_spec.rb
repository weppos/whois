...
describe Whois::Record::Parser::WhoisNicMs, "status_registered.expected" do
  ...
  describe "#domain" do
    it do
      subject.domain.should == "google.ms"
    end
  end
  describe "#domain_id" do
    it do
      subject.domain_id.should == "23725-CoCCA"
    end
  end
  describe "#status" do
    it do
  ...
  describe "#updated_on" do
    it do
      ...
      subject.updated_on.should == Time.parse("2013-05-06 21:44:36 UTC")
    end
  end
  describe "#expires_on" do
    it do
      subject.expires_on.should be_a(Time)
      subject.expires_on.should == Time.parse("2014-06-04 12:00:00 UTC")
    end
  end
