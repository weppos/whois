...
require 'spec_helper'
require 'whois/record/parser/whois.je.rb'

describe Whois::Record::Parser::WhoisJe, "status_registered.expected" do

  subject do
    file = fixture("responses", "whois.je/status_registered.txt")
  ...
  describe "#created_on" do
    it do
      ...
      subject.created_on.should == Time.parse("2002-10-31 00:00:00 UTC")
    end
  end
  describe "#updated_on" do
    it do
      subject.updated_on.should be_a(Time)
      subject.updated_on.should == Time.parse("2011-10-05 14:28:00 UTC")
    end
  end
