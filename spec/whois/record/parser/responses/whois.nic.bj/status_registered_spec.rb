...
#
#   /spec/fixtures/responses/whois.nic.bj/status_registered.expected
#
...
require 'spec_helper'
require 'whois/record/parser/whois.nic.bj.rb'

describe Whois::Record::Parser::WhoisNicBj, "status_registered.expected" do

  subject do
    file = fixture("responses", "whois.nic.bj/status_registered.txt")
