...
#
#   /spec/fixtures/responses/whois.nic.bj/status_available.expected
#
...
describe Whois::Record::Parser::WhoisNicBj, "status_available.expected" do

  subject do
    file = fixture("responses", "whois.nic.bj/status_available.txt")
