...
#
#   /spec/fixtures/responses/whois.nic.io/status_reserved.expected
#
...
describe Whois::Record::Parser::WhoisNicIo, "status_reserved.expected" do

  subject do
    file = fixture("responses", "whois.nic.io/status_reserved.txt")
