...
class AnswerParserWhoisJaNetAcUkTest < AnswerParserWhoisJaNetTest
  ...
  def test_status
    parser    = @klass.new(load_part('/ac.uk/registered.txt'))
    expected  = :registered
    assert_equal  expected, parser.status
    assert_equal  expected, parser.instance_eval { @status }

    parser    = @klass.new(load_part('/ac.uk/available.txt'))
    expected  = :available
    assert_equal  expected, parser.status
    assert_equal  expected, parser.instance_eval { @status }
  end
...
class AnswerParserWhoisJaNetGovUkTest < AnswerParserWhoisJaNetTest
  ...
  def test_status
    parser    = @klass.new(load_part('/gov.uk/registered.txt'))
    expected  = :registered
    assert_equal  expected, parser.status
    assert_equal  expected, parser.instance_eval { @status }

    parser    = @klass.new(load_part('/gov.uk/available.txt'))
    expected  = :available
    assert_equal  expected, parser.status
    assert_equal  expected, parser.instance_eval { @status }
  end
