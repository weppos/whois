require 'test_helper'
require 'whois/answer/parser/whois.usp.ac.fj'

class AnswerParserWhoisUspAcFjTest < Whois::Answer::Parser::TestCase

  def setup
    @klass  = Whois::Answer::Parser::WhoisUspAcFj
  ...
  def test_expires_on
    parser    = @klass.new(load_part('registered.txt'))
    expected  = Time.parse("2011-04-28")
