require 'test_helper'
require 'whois/answer/parser/whois.gg'

class AnswerParserWhoisGgTest < Whois::Answer::Parser::TestCase

  def setup
    @klass  = Whois::Answer::Parser::WhoisGg
    @host   = "whois.gg"
  end
  ...
  def test_nameservers
    parser    = @klass.new(load_part('status_registered.txt'))
    expected  = %w( ns1.google.com ns4.google.com ns2.google.com ns3.google.com ).map { |ns| nameserver(ns) }
