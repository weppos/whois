require 'test_helper'
require 'whois/answer/parser/whois.nic.ck'

class AnswerParserWhoisNicCkTest < Whois::Answer::Parser::TestCase

  def setup
    @klass  = Whois::Answer::Parser::WhoisNicCk
    @host   = "whois.nic.ck"
  end
  ...
  def test_expires_on
    parser    = @klass.new(load_part('registered.txt'))
    expected  = Time.parse("2011-11-01")
