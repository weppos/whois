...
class AnswerParserWhoisNicChTest < Whois::Answer::Parser::TestCase
  ...
  def test_nameservers_with_ip
    parser    = @klass.new(load_part('status_property_nameservers_with_ip.txt'))
    names     = %w( ns1.citrin.ch     ns2.citrin.ch     )
    ipv4s     = %w( 193.247.72.8      62.12.149.3       )
    ipv6s     = %w( 2001:8a8:21:5::11 2001:8a8:21:5::12 )
