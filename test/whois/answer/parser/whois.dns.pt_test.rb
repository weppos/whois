require 'test_helper'
require 'whois/answer/parser/whois.dns.pt'

class AnswerParserWhoisDnsPtTest < Whois::Answer::Parser::TestCase

  def setup
    @klass  = Whois::Answer::Parser::WhoisDnsPt
    @host   = "whois.dns.pt"
  end
