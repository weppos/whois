require 'test_helper'
require 'whois/answer/parser/whois.je'

class AnswerParserWhoisJeTest < Whois::Answer::Parser::TestCase

  def setup
    @klass  = Whois::Answer::Parser::WhoisJe
    @host   = "whois.je"
  end
  ...
  def test_nameservers
    parser    = @klass.new(load_part('registered.txt'))
    expected  = %w( ns1.google.com ns3.google.com ns2.google.com ns4.google.com ).map { |ns| nameserver(ns) }
