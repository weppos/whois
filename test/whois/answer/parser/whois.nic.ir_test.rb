require 'test_helper'
require 'whois/answer/parser/whois.nic.ir'

class AnswerParserWhoisNicIrTest < Whois::Answer::Parser::TestCase

  def setup
    @klass  = Whois::Answer::Parser::WhoisNicIr
    @host   = "whois.nic.ir"
  end
  ...
  def test_updated_on
    parser    = @klass.new(load_part('status_registered.txt'))
    expected  = Time.parse("2008-11-09")
