...
* ADDED: Base .fr TLD parser.

* ADDED: Base .name TLD parser.

* ADDED: Base .ie TLD parser.

* ADDED: Base .edu TLD parser.

* CHANGED: Changed .edu TLD server from whois.educause.net to whois.educause.edu (see http://www.iana.org/domains/root/db/edu.html)
