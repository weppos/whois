...
* NEW: Added .mg TLD parser (whois.nic.mg).

* NEW: Added .ms TLD parser (whois.nic.ms).

* NEW: Added .ms TLD parser (whois.domainregistry.my).

* NEW: Added .na TLD parser (whois.na-nic.com.na).
