...
* ADDED: Simple .bg parser.

* ADDED: Simple .ca parser.

* ADDED: Simple .ch parser.

* ADDED: Simple .eu parser.

* ADDED: Simple .gl parser.

* ADDED: Simple .im parser.

* ADDED: Simple .is parser.

* ADDED: Simple .ly parser.

* ADDED: Simple .me parser.

* ADDED: Simple .mu parser.

* ADDED: Simple .nl parser.

* ADDED: Simple .no parser.

* ADDED: Simple .fo, .gm, .mc, .sm, .va parsers (whois.ripe.net).

* ADDED: Simple .tl parser.

* ADDED: Simple .tel parser.

* ADDED: Simple .us parser.

* ADDED: Simple .biz parser.

* ADDED: Simple .mobi parser.

* ADDED: Simple .museum parser.

* ADDED: Simple .io parser.

* ADDED: Simple .ro parser.

* ADDED: Simple .br parser.

* ADDED: Simple .travel parser.

* ADDED: .cc, .jobs parsers (verisign).
